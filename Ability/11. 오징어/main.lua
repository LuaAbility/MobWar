...
function onEvent(funcTable)
	if funcTable[1] == "MW011-blind" and funcTable[2]:getEventName() == "EntityDamageByEntityEvent" then blind(funcTable[2], funcTable[4], funcTable[1]) end
end

function blind(event, ability, id)

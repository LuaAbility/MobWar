...
function onEvent(funcTable)
	if funcTable[1] == "MW027-fly" then fly(funcTable[2], funcTable[4], funcTable[1]) end
	if funcTable[1] == "MW027-cancelFallDamage" then cancelFallDamage(funcTable[2], funcTable[4], funcTable[1]) end
	if funcTable[1] == "MW027-cancelTarget" and funcTable[2]:getEventName() == "EntityTargetLivingEntityEvent" then cancelTarget(funcTable[2], funcTable[4], funcTable[1]) end
end

function fly(event, ability, id)
...
function cancelFallDamage(event, ability, id)

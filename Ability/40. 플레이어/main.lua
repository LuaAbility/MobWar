...
function onEvent(funcTable)
	if funcTable[1] == "MW040-changeDifficult" then changeDifficult(funcTable[2], funcTable[4], funcTable[1]) end
	if funcTable[1] == "MW040-calculateDamage" and funcTable[2]:getEventName() == "EntityDamageByEntityEvent" then calculateDamage(funcTable[2], funcTable[4], funcTable[1]) end
end
...
function changeDifficult(event, ability, id)
...
function calculateDamage(event, ability, id)
	...
	if damager:getType():toString() == "PLAYER" and damagee:getType():toString() == "PLAYER" then
		...
		if game.checkCooldown(game.getPlayer(damager), ability, id) then

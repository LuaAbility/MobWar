	...
	plugin.registerEvent(abilityData, "EntityDamageByEntityEvent", 0, function(a, e)
		...
		if damager:getType():toString() == "PLAYER" and damagee:getType():toString() == "PLAYER" then
			if game.checkCooldown(damagee, a, 1) then
				if game.getPlayer(damagee):getVariable("MW040-difficult") == "1" then e:setDamage(e:getDamage() * 0.5)
				elseif game.getPlayer(damagee):getVariable("MW040-difficult") == "2" then e:setDamage(e:getDamage() * 0.75)
				elseif game.getPlayer(damagee):getVariable("MW040-difficult") == "3" then e:setDamage(e:getDamage())
				elseif game.getPlayer(damagee):getVariable("MW040-difficult") == "4" then e:setDamage(e:getDamage() * 1.25)
				else e:setDamage(e:getDamage() * 1.5) end
			end
			
			if game.checkCooldown(damager, a, 1) then
				if game.getPlayer(damager):getVariable("MW040-difficult") == "1" then e:setDamage(e:getDamage() * 0.5)
				elseif game.getPlayer(damager):getVariable("MW040-difficult") == "2" then e:setDamage(e:getDamage() * 0.75)
				elseif game.getPlayer(damager):getVariable("MW040-difficult") == "3" then e:setDamage(e:getDamage())
				elseif game.getPlayer(damager):getVariable("MW040-difficult") == "4" then e:setDamage(e:getDamage() * 1.5)
...
function setDifficult(p)
	...
	game.getPlayer(p):setVariable("MW040-difficult", tostring(difficult)) 

...
function onEvent(funcTable)
	if funcTable[1] == "MW005-panelty" then panelty(funcTable[2], funcTable[4], funcTable[1]) end
	if funcTable[1] == "MW005-removeDamage" then removeDamage(funcTable[2], funcTable[4], funcTable[1]) end
end
...
function removeDamage(event, ability, id)

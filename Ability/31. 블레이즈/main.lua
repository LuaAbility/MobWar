...
function onEvent(funcTable)
	if funcTable[1] == "MW031-shootFireball" then shootFireball(funcTable[2], funcTable[4], funcTable[1]) end
	if funcTable[1] == "MW031-cancelDamage" and funcTable[2]:getEventName() == "EntityDamageByEntityEvent" then cancelDamage(funcTable[2], funcTable[4], funcTable[1]) end
